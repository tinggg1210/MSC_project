...
* open `NTU_detect.ipynb` with `visual code studio`, select virtual environment `stomaenv`
...
5. put the folders contain .xml files under folder "data", 
...
For example, to describe there is a issue of an unexpected mismatch picture names from `clean_ntu.R`. 
